...
const steps = [
    { name: "Order Placed", description: "on thursday, 11th July", value: "PLACED" },
    { name: "Packed", description: "Items packed in warehouse", value: "CONFIRMED" },
    { name: "Shipped", description: "by Mon, 15th Jul", value: "SHIPPED" },
    { name: "Arriving", description: "by 16 Jul - 18 Jul", value: "ARRIVING" },
    { name: "Arrived", description: "by 16 Jul - 18 Jul", value: "DELIVERED" },
]

const canceledSteps = [
    { name: "Order Placed", description: "on Thu, 11th July", value: "PLACED" },
    { name: "Order Canceled", description: "by Thu, 11th Jul", value: "CANCELED" },
]
                        ...
                        <div className='flex flex-col items-center'>
                            <Box
                                ...
                                className={`w-8 h-8 rounded-full flex items-center justify-center
                                        z-10 ${index <= currentStep ? "bg-gray-200 text-teal-500" : "bg-gray-300 text-gray-600"}
                                    `}
                            >
                                {
